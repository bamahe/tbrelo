...
primaryKeyword: "Florida thunderstorm tips"
...
The National Weather Service reports that Florida sees roughly 25 lightning strikes per square mile annually. In [Hillsborough County](/counties/hillsborough/), you're more likely to experience a severe thunderstorm than find decent Cuban food (and that's saying something).
...
Florida thunderstorms terrify animals who aren't used to the intensity. Dogs especially struggle with the sudden pressure changes and constant rumbling. [ThunderShirts]({{amazon:B0028QH5GY}}) actually work for many pets, creating compression that calms anxiety.
