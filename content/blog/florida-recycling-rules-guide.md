...
primaryKeyword: "Florida recycling what goes in bin"
...
![Florida recycling bins with various items showing what's accepted and rejected](PLACEHOLDER)
...
In [Hillsborough County](/counties/hillsborough/), you might be able to recycle pizza boxes. Drive 20 minutes to Pinellas, and those same boxes contaminate the load. It's maddening, but it's reality.
...
![Recycling sorting facility showing contaminated materials being separated](PLACEHOLDER)
...
![Close-up of properly cleaned containers ready for recycling](PLACEHOLDER)
...
## Getting Your [Moving Checklist](/moving-checklist/) Right

When you're relocating to Florida, figuring out recycling rules should be on your setup list along with [utilities](/utilities/) and voter registration.
