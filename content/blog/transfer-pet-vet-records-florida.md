...
primaryKeyword: "moving to Florida with pets vet records"
...
![Veterinarian reviewing pet medical records with Florida state requirements checklist](PLACEHOLDER)
...
Cats need the same documentation, though enforcement varies by county. In [Hillsborough County](/counties/hillsborough/), animal control takes this seriously — I've seen new residents get citations during routine pet registration.
...
![Pet owner organizing veterinary records with Florida vaccination requirements visible on computer screen](PLACEHOLDER)
...
![Florida veterinarian examining a newly relocated pet with complete medical records displayed on examination table](PLACEHOLDER)
...
Pet record transfers should coordinate with your broader moving timeline. Include veterinary appointments in your [moving checklist](/moving-checklist/) alongside utility transfers and address changes.
