...
primaryKeyword: "Tampa Bay library card"
...
## Pasco County Libraries — The Growing Network
...
**Instead of Netflix:** Kanopy + Hoopla covers documentaries, indie films, and classic movies
**Instead of Audible:** Hoopla, OverDrive, and CloudLibrary for audiobooks
**Instead of LinkedIn Learning:** Direct access through library systems
**Instead of Consumer Reports:** Full digital access through library databases
**Instead of Ancestry.com:** Heritage Quest and other genealogy databases
...
Getting your library card fits naturally into other relocation tasks. When you're setting up [utilities](/utilities/) or working through your [moving checklist](/moving-checklist/), add library registration to the list. Many new residents handle voter registration and library cards during the same trip, since both require similar documentation.
