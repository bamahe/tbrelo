...
- Zone A includes all of [Apollo Beach](/cities/apollo-beach/), Davis Islands, Bayshore, parts of South Tampa, and coastal areas along the bay.
- Zones B–C cover much of [Tampa](/cities/tampa/) proper, [Riverview](/cities/riverview/) (low areas), and western Hillsborough.
- Eastern Hillsborough ([Brandon](/cities/brandon/), [Valrico](/cities/valrico/), [Plant City](/cities/plant-city/)) is mostly Zone D or non-evacuation.
- [FishHawk Ranch](/cities/fishhawk-ranch/) and eastern [Lithia](/cities/lithia/) are generally non-evacuation zones.

**[Pinellas County](/counties/pinellas/)**
- Pinellas is almost entirely in evacuation zones due to its peninsula geography. All barrier island communities ([Indian Rocks Beach](/cities/indian-rocks-beach/), [Madeira Beach](/cities/madeira-beach/), [St. Pete Beach](/cities/st-pete-beach/), [Treasure Island](/cities/treasure-island/), [Clearwater Beach](/cities/clearwater/)) are Zone A.
- Much of [St. Petersburg](/cities/st-petersburg/), [Clearwater](/cities/clearwater/), [Largo](/cities/largo/), and [Dunedin](/cities/dunedin/) falls in Zones A–C.
- Only the highest-elevation interior areas are Zone D or non-evacuation.
- **If you live in Pinellas, have an evacuation plan.** Period.

**[Pasco County](/counties/pasco/)**
- Coastal areas ([Hudson](/cities/hudson/), [Holiday](/cities/holiday/), [Port Richey](/cities/port-richey/)) are Zones A–B.
- [New Port Richey](/cities/new-port-richey/) varies by specific location.
- [Wesley Chapel](/cities/wesley-chapel/), [Land O' Lakes](/cities/land-o-lakes/), [Zephyrhills](/cities/zephyrhills/) — mostly non-evacuation zones.
- [Dade City](/cities/dade-city/) — non-evacuation.

**[Hernando County](/counties/hernando/)**
- Coastal areas ([Hernando Beach](/cities/hernando-beach/), [Weeki Wachee](/cities/weeki-wachee/) coast) are Zones A–B.
- [Spring Hill](/cities/spring-hill/) varies — western Spring Hill can be Zone B–C, eastern Spring Hill is safer.
- [Brooksville](/cities/brooksville/) — mostly non-evacuation (higher elevation).

**[Polk County](/counties/polk/)**
- Inland county — minimal storm surge risk. [Lakeland](/cities/lakeland/), [Winter Haven](/cities/winter-haven/), [Bartow](/cities/bartow/) are generally non-evacuation zones.
- Flooding around lakes is the primary risk.
- Polk is where many coastal residents evacuate TO.

**[Manatee County](/counties/manatee/)**
- [Anna Maria Island](/cities/anna-maria-island/), [Bradenton Beach](/cities/bradenton-beach/), [Holmes Beach](/cities/holmes-beach/), [Longboat Key](/cities/longboat-key/) — all Zone A.
- Coastal [Bradenton](/cities/bradenton/) and [Palmetto](/cities/palmetto/) — Zones A–C depending on elevation.
- [Lakewood Ranch](/cities/lakewood-ranch/) and [Parrish](/cities/parrish/) — mostly non-evacuation.

**[Sarasota County](/counties/sarasota/)**
- Barrier islands ([Siesta Key](/cities/siesta-key/), [Lido Key](/cities/lido-key/), [Longboat Key](/cities/longboat-key/), [Venice](/cities/venice/) island) — Zone A.
- Coastal [Sarasota](/cities/sarasota/) — Zones A–B.
- [North Port](/cities/north-port/) — mostly non-evacuation but has flooding risk from the Myakkahatchee Creek.
- [Osprey](/cities/osprey/) and [Nokomis](/cities/nokomis/) — Zones A–C near the water.

**[Citrus County](/counties/citrus/)**
- Coastal areas (Crystal River, Homosassa) — Zones A–B.
- Inland areas — mostly non-evacuation.

### What "Evacuate" Actually Means

Evacuation doesn't mean "drive to Georgia." It means get out of the storm surge zone. Driving 15–20 miles inland is usually sufficient. If you're in Zone A in [St. Petersburg](/cities/st-petersburg/), you could evacuate to a friend's house in [Lakeland](/cities/lakeland/) or [Brandon](/cities/brandon/) — you don't need to leave the state.
...
- **Impact windows ($40–$60/sq ft installed):** Replace your windows entirely with impact-rated glass. Expensive but eliminates the need for shutters, reduces insurance costs, and improves energy efficiency. Many homeowners do this during renovation. Ask {{bbs}} about installation options.
...
If you're leaving for the storm, consider your home security. {{simplisafe}} and {{adt}} offer systems with cellular backup that keep monitoring even when power and internet are down. Cameras with battery backup can help you check on your property remotely during and after the storm.
